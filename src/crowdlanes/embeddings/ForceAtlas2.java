...
public class ForceAtlas2 implements Layout {
    ...
    private void forceSmoothening() {
        SmootheningScalarStage smoothDx = new SmootheningScalarStage(0.1f, 100, "normal", new SmootheningDataProvider() {
        ...
        SmootheningScalarStage smoothDy = new SmootheningScalarStage(0.1f, 100, "normal", new SmootheningDataProvider() {
        ...
        smoothDx.run(graph, 0, 0, true);
        smoothDy.run(graph, 0, 0, true);

        for (Node n : graph.getNodes()) {
            ForceAtlas2LayoutData nLayout = n.getNodeData().getLayoutData();
            nLayout.dx = smoothDx.getValue(n);
            nLayout.dy = smoothDy.getValue(n);
        }
    }
}
